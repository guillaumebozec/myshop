...
<section>
  ...
  <div class="h-[82.60px] p-[22.30px] bg-sky-300 rounded-[22.30px] flex-col justify-center items-center gap-[22.30px] flex">
    <div class="text-neutral-600 text-[26.76px] font-black font-['Arial Black']"><button v-on:click="adduser()">SUBMIT</button></div>
  </div>
</div>
</section>
</template>
    ...
    methods: 
    {
        async adduser(){
          ...
          password:this.password,
            ...
            await fetch("http://localhost/api/users", requestOptions )
